...
np.save('data/processed1/freq.npy',np.stack(f))
np.save('data/processed1/psds.npy',np.stack(psds))
np.save('data/processed1/labels.npy',np.stack(labels))
np.save('data/processed1/anomaly.npy',np.stack(anomaly))
np.save('data/processed1/states.npy',np.stack(state))
# %%
